map_to_click = reshape(ABBA_rats,31,31); %%Input your map here%%%
dirac_Es = draw_Es;   %%%%Input your E vector (units of frame pixels)
dirac_ks = draw_ks;   %%%%Input your k vector
...
while abcd==1
    ...
    E_off_ABBAn_it = ((draw_Es(clicked_i) - round(bin_E/2))/bin_E) - E_0;
    K_off_ABBAn_it = ((draw_ks(clicked_i) - round(bin_k/2))/bin_k) - K_0 - fass_k_off;
    ABBAn_it_it = draw_As(clicked_i);
    BAABn_it_it = draw_Bs(clicked_i);
    MC_ABBAn_it = draw_MCs(clicked_i);
