...
E_map_pix = reshape(draw_Es_906,31,31);
FL_map_pix = reshape(fermi_,31,31);
K_map_pix = reshape(draw_ks_906,31,31);
V_map_pix = (reshape(draw_As_906,31,31));
B_map_pix = reshape(draw_Bs_906,31,31);
MC_map = reshape(draw_MCs_906,31,31);
